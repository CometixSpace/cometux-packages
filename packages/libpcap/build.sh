...
# Cometux: upstream points at fossies.org, which only mirrors the newest
# release and returns 410 Gone for anything older (nmap/tcpdump builds
# fail on it). Official tcpdump.org release archive keeps every version.
