...
# Default value: `termux`
##
TERMUX__REPOS_HOST_ORG_NAME="CometixSpace"
...
##
TERMUX_APP__PACKAGE_NAME="dev.cometix.cometux"
...
# Cometux hosts its own repository (see repo.json), built with these
# very values, so they match the app package name above. That is what
# lets the -i/-I flags actually download dependencies instead of
# compiling the whole tree locally for every build.
TERMUX_REPO_APP__PACKAGE_NAME="dev.cometix.cometux"
TERMUX_REPO_APP__DATA_DIR="/data/data/dev.cometix.cometux"
TERMUX_REPO__CORE_DIR="/data/data/dev.cometix.cometux/termux/core"
TERMUX_REPO__APPS_DIR="/data/data/dev.cometix.cometux/termux/app"
TERMUX_REPO__ROOTFS="/data/data/dev.cometix.cometux/files"
TERMUX_REPO__HOME="/data/data/dev.cometix.cometux/files/home"
TERMUX_REPO__PREFIX="/data/data/dev.cometix.cometux/files/usr"
